...
public class NetRequestGD {
     ...
     */
    public NetRequestGD(String logTag) {
        this.LOG_TAG = logTag;
        this.url = "";
     ...
     * @param url    网络地址
     */
    public NetRequestGD(String logTag, String url) {
        this.LOG_TAG = logTag;
        this.url = url;
        reqList = new ArrayList<>();
        reqList.clear();
     ...
     */
    public NetRequestGD(String logTag, String url, int timeout) {
        this.LOG_TAG = logTag;
        this.url = url;
        this.timeout = timeout;
        reqList = new ArrayList<>();
